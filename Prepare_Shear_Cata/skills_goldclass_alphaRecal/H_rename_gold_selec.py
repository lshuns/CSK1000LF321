# -*- coding: utf-8 -*-
# @Author: ssli
# @Date:   2022-12-25 12:10:12
# @Last Modified by:   ssli
# @Last Modified time: 2022-12-25 12:21:52
...
# the shear catalogue
inpath = '/disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//skills_v07D7_LF_321_kidsPhotometry_shear_noSG_newCut_A1_WeiCut_goldclasses.cat.A2.feather'

# where to save
outpath = '/disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//skills_v07D7_LF_321_kidsPhotometry_shear_noSG_newCut_A12_WeiCut_goldclasses_goldSelected.cat'

# the LDAC template
ldac_template = "../../utils/LDAC.cat"

# csv file includes wanted columns
wanted_cols = '../utils/wanted_cols_skills_v07D7_A12_SOM.csv'
...
# number original 29,437,426
# number gold 29,437,426
# LDAC info:
# Filename: ../../utils/LDAC.cat
# No.    Name      Ver    Type      Cards   Dimensions   Format
#   0  PRIMARY       1 PrimaryHDU       4   ()      
#   1  FIELDS        1 BinTableHDU     24   65534R x 5C   [1J, 1J, 1J, 16A, 1J]   
#   2  OBJECTS       1 BinTableHDU    186   29437426R x 59C   ['1J', '1E', '1E', '1E', '1E', '1J', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1E', '1I', '1E', '1E', '1E', '1E', '1E', '1E', '16A', '16A', '1I', '1E', '1E', '1E', '1E', '1E', '1I', '1E', '1E']   
# saved as /disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//skills_v07D7_LF_321_kidsPhotometry_shear_noSG_newCut_A12_WeiCut_goldclasses_goldSelected.cat
# Elapsed:3:58.60,User=227.546,System=127.864,CPU=148.9%.