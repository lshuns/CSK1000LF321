...
# @Last Modified time: 2022-12-25 11:25:48
...
######### 20 cores
# use parameter file /net/grecht/data2/ssli_files/Projects/Projects/10CSK1000/Prepare_Shear_Cata/skills_goldclass_alphaRecal/F_config_SOM_gold.param
# Constructing Spectroscopic Adapt Catalogue {
# Reading /disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//KiDS_specz_PAUS_COSMOS2015.csv - Done
...
# Writing /disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//KiDS_specz_PAUS_COSMOS2015_adapt.fits - Done
# } - Done
...
#    --> /disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//KiDS_specz_PAUS_COSMOS2015_adapt.fits
# And corresponding input reference catalogue(s):
#    --> /disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//skills_v07D7_LF_321_kidsPhotometry_shear_noSG_newCut_A1_WeiCut_DIRcols.cat
# Working on Catalogues:
#      /disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//KiDS_specz_PAUS_COSMOS2015_adapt.fits 
#      /disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//skills_v07D7_LF_321_kidsPhotometry_shear_noSG_newCut_A1_WeiCut_DIRcols.cat 
#   > Reading Training Catalogue - Done 42 sec 
#   > Reading Reference Catalogue - Done 1 sec 
...
#     -> constructing SOM from full data vector - Done 9 min 35 sec 
#  - Done 9 min 40 sec  
...
# DIR weight Generation completed in 10 min 29 sec ( 43 sec catalogue IO)
...
# /disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//skills_v07D7_LF_321_kidsPhotometry_shear_noSG_newCut_A1_WeiCut.cat
# /disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//skills_v07D7_LF_321_kidsPhotometry_shear_noSG_newCut_A1_WeiCut_DIRcols_allgoldclass.fits
# /disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//skills_v07D7_LF_321_kidsPhotometry_shear_noSG_newCut_A1_WeiCut_goldclasses.cat
# ['NONE']
# Everything is well with the world - continue
# Everything is well with the world - continue
# Looping over Columns
# adding column Flag_SOM_Fid_NONE to ldac table
# writing out file /disks/shear10/ssli/K1000CS//skills_v07D7_Inputs//skills_v07D7_LF_321_kidsPhotometry_shear_noSG_newCut_A1_WeiCut_goldclasses.cat
# } - Done
# Elapsed:3:30:40.26,User=70179.909,System=4706.328,CPU=651.1%.