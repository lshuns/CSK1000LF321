...
# @Last Modified time: 2022-12-25 12:17:26
...
inpath_list = glob.glob(os.path.join('/disks/shear16/ssli/KiDS/K1000_LF_321', 'KIDS_*_r_SDSS.V1.0.0A_ugriZYJHKs_photoz_SG_mask_LF_glab_321_v2.cat'))
Ntiles = len(inpath_list)
print('number of tiles found', Ntiles)

# out files
outpath = f'/disks/shear16/ssli/KiDS/K1000_LF_321_mosaic/KIDS_{Ntiles}tiles_r_SDSS.V1.0.0A_ugriZYJHKs_photoz_SG_mask_LF_glab_321_v2.feather'
...
# combined cata saved to /disks/shear16/ssli/KiDS/K1000_LF_321_mosaic/KIDS_1006tiles_r_SDSS.V1.0.0A_ugriZYJHKs_photoz_SG_mask_LF_glab_321_v2.feather
