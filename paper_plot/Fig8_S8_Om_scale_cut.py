# -*- coding: utf-8 -*-
# @Author: lshuns
# @Date:   2023-09-11 17:40:28
# @Last Modified by:   lshuns
# @Last Modified time: 2023-09-11 17:59:14

### plot S8 vs Omega_m contours with chaincosumer
###### compare between scale cut and no scale cut
...
outpath = './plots/S8_Om_scale_cut.pdf'
# outpath = 'show'

inpath_list = ['/disks/shear10/ssli/K1000CS/LF321_cosmo/cosebis/multinest_nIA/output_multinest_nIA.txt',
                '/disks/shear10/ssli/K1000CS/LF321_cosmo/cosebis/multinest_nIA_noCut/output_multinest_nIA_noCut.txt'
               ]
LABELs = [r'$\theta_{\rm min}=2\ensuremath{^\prime}$',
            r"$\theta_{\rm min}=0.\!'5$"]
COLORs = ['grey', 'purple']
ALPHAs = [0.5, 0]
LSs = ['--', '-']
