# -*- coding: utf-8 -*-
# @Author: lshuns
# @Date:   2023-05-19 16:12:38
# @Last Modified by:   lshuns
# @Last Modified time: 2023-06-01 09:18:52

### plot S8 and cosmo para contours with chaincosumer
...
paras = ['s8', 'omch2', 'ombh2', 
            'h', 'n_s', 'logt_agn']
paras_label = [r'$S_8$', r'$\omega_{\rm c}$', r'$\omega_{\rm b}$',
                r'$h$', r'$n_{\rm s}$', r'$\log_{10}(T_{\rm AGN})$']
...
xlims = [[0.65, 0.85], None, None, None, None, None, 
        [0.65, 0.85], [0.051, 0.255], None, None, None, None, 
        [0.65, 0.85], [0.051, 0.255], [0.019, 0.026], None, None, None, 
        [0.65, 0.85], [0.051, 0.255], [0.019, 0.026], [0.64, 0.82], None, None,
        [0.65, 0.85], [0.051, 0.255], [0.019, 0.026], [0.64, 0.82], [0.84, 1.1], None,
        [0.65, 0.85], [0.051, 0.255], [0.019, 0.026], [0.64, 0.82], [0.84, 1.1], [7.3, 8.0]
        ]

xticks = [[0.7, 0.8], None, None, None, None, None, 
        [0.7, 0.8], [0.1, 0.2], None, None, None, None, 
        [0.7, 0.8], [0.1, 0.2], [0.020, 0.024], None, None, None, 
        [0.7, 0.8], [0.1, 0.2], [0.020, 0.024], [0.7, 0.8], None, None,
        [0.7, 0.8], [0.1, 0.2], [0.020, 0.024], [0.7, 0.8], [0.94, 1.04], None,
        [0.7, 0.8], [0.1, 0.2], [0.020, 0.024], [0.7, 0.8], [0.94, 1.04], [7.4, 7.6, 7.8]
        ]
xtick_labels = [['']*2, None, None, None, None, None, 
...
ylims = [None, None, None, None, None, None, 
        [0.051, 0.255], None, None, None, None, None, 
        [0.019, 0.026], [0.019, 0.026], None, None, None, None, 
        [0.64, 0.82], [0.64, 0.82], [0.64, 0.82], None, None, None,
        [0.84, 1.1], [0.84, 1.1], [0.84, 1.1], [0.84, 1.1], None, None,
        [7.3, 8.0], [7.3, 8.0], [7.3, 8.0], [7.3, 8.0], [7.3, 8.0], None
        ]
yticks = [None, None, None, None, None, None, 
        [0.1, 0.2], None, None, None, None, None, 
        [0.020, 0.024], [0.020, 0.024], None, None, None, None, 
        [0.7, 0.8], [0.7, 0.8], [0.7, 0.8], None, None, None,
        [0.94, 1.04], [0.94, 1.04], [0.94, 1.04], [0.94, 1.04], None, None,
        [7.4, 7.6, 7.8], [7.4, 7.6, 7.8], [7.4, 7.6, 7.8], [7.4, 7.6, 7.8], [7.4, 7.6, 7.8], None
        ]
ytick_labels = [None, None, None, None, None, None, 
        ['0.1', '0.2'], None, None, None, None, None, 
        ['0.020', '0.024'], ['']*2, None, None, None, None, 
        ['0.7', '0.8'], ['']*2, ['']*2, None, None, None,
        ['0.94', '1.04'], ['']*2, ['']*2, ['']*2, None, None,
        ['7.4', '7.6', '7.8'], ['']*3, ['']*3, ['']*3, ['']*3, None
        ]
...
for i_ax, ax in enumerate(axs):
    ...
    if (i_ax == 6) or (i_ax==12) or (i_ax==18) or (i_ax==24) or (i_ax==30) or (i_ax==36):
